...
gsed -i "s/\"com.slack:bolt-jetty:[0-9]\+\.[0-9]\+\.[0-9]\+\"/\"com.slack:bolt-jetty:${new_version}\"/g" bolt-docker-examples/echo-command-app/build.gradle
gsed -i "s/\"com.slack:bolt-jetty:[0-9]\+\.[0-9]\+\.[0-9]\+-SNAPSHOT\"/\"com.slack:bolt-jetty:${new_version}\"/g" bolt-docker-examples/echo-command-app/build.gradle
